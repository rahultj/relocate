...
**Repo now has Vitest** (`pnpm test`, 72 tests): pure helpers in `lib/` (item-save, contact + **contactHref**, slug, category, **csv description join**, **venmo + csv Venmo mapping**, **CSV template**) + backfilled csv/format.
