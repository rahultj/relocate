...
**Repo now has Vitest** (`pnpm test`, 70 tests): pure helpers in `lib/` (item-save, contact + **contactHref**, slug, category, **csv description join**, **venmo + csv Venmo mapping**) + backfilled csv/format.
